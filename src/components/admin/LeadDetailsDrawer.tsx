      ...
      <div className="flex-1 overflow-y-auto p-8 space-y-10 font-urbanist">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white/05 p-4 rounded border border-white/05">
              <p className="text-[9px] text-white/30 uppercase mb-1">Data Registro</p>
              <p className="text-xs text-white/70">{format(new Date(lead.created_at), "d 'de' MMMM, yyyy", { locale: ptBR })}</p>
            </div>
            <div className="bg-white/05 p-4 rounded border border-white/05">
              <p className="text-[9px] text-white/30 uppercase mb-1">Canal</p>
              <p className="text-xs text-white/70">{lead.utm_source || "Direto"}</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            {isSaving && <span className="text-[9px] text-white/20 animate-pulse uppercase">Salvando...</span>}
          </div>
          <textarea 
            value={notes}
