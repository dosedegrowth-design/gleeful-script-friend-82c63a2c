...
export const WhatsAppButton = () => {
  return (
    <a
      ...
      className="whatsapp-float fixed bottom-8 right-8 z-[800] w-[52px] h-[52px] bg-gold rounded-full flex items-center justify-center shadow-[0_8px_32px_rgba(173,137,87,0.3)] transition-all duration-300 hover:scale-110 hover:bg-gold-l group"
    >
