...
export const Footer = () => {
  ...
  const email = cx("footer.email", "hello@mooviaportugal.com");
  const whatsapp = cx("footer.whatsapp", "351910000000");
  const linkedin = cx("footer.linkedin", "https://www.linkedin.com/company/moovia-portugal");
  const address = cx("footer.address", "Avenida da Liberdade, Lisboa · PT");
      ...
      <div className="max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-[1fr_auto_auto] gap-20 mb-20">
        ...
        <div>
          ...
          <ul className="space-y-4 font-urbanist font-light text-[13px] text-white/40">
            <li><a href="/assessment" className="hover:text-gold transition-colors">{cx("nav.link_assessment", "Assessment")}</a></li>
