    ...
    >
      ...
      >
        <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full animate-[slowspin_120s_linear_infinite]">
          ...
          <path d="M100 88 V112 M88 100 H112" stroke="#ad8957" strokeWidth="0.5" strokeLinecap="round"/>
          <circle cx="100" cy="180" r="2" fill="#ad8957"/>
          <circle cx="20" cy="100" r="2" fill="#ad8957"/>
