        ...
        <div className="mx-auto max-w-3xl px-6 md:px-10 py-20">
          {isLoading && !post ? (
            ...
            <>
              ...
              <div className="mt-24 p-12 border border-border bg-black-2 relative overflow-hidden group">
                ...
                <h2 className="font-amotha text-[clamp(24px,3vw,36px)] font-extralight text-white leading-tight mb-8">Avalie o seu caso com a MOOVIA.</h2>
