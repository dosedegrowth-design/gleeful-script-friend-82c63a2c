...
export const PHRASES: Record<string, Phrase> = {
  ...
  "Equipa": { "pt-BR": "Equipe", es: "Equipo", en: "Team" },
  ...
  "Sem custo · Calendly": { "pt-BR": "Sem custo · Calendly", es: "Sin coste · Calendly", en: "No cost · Calendly" },
  "Uma conversa direta com o founder, sem script, sem chatbot. Validamos o fit e mostramos como a MOOVIA pensa o seu caso.": {
    "pt-BR": "Uma conversa direta com o founder, sem script, sem chatbot. Validamos o fit e mostramos como a MOOVIA pensa o seu caso.",
    es: "Una conversación directa con el fundador, sin guion, sin chatbot. Validamos el encaje y mostramos cómo MOOVIA piensa su caso.",
    en: "A direct conversation with the founder, no script, no chatbot. We validate fit and show how MOOVIA thinks through your case.",
  },
  "Sem custo · Agendamento via Calendly": { "pt-BR": "Sem custo · Agendamento via Calendly", es: "Sin coste · Agenda vía Calendly", en: "No cost · Book via Calendly" },
  ...
  "90 minutos com entregável físico. Mapeamento completo de perfil, riscos, estratégias e cronograma. Não é consulta: é diagnóstico.": {
    "pt-BR": "90 minutos com entregável físico. Mapeamento completo de perfil, riscos, estratégias e cronograma. Não é consulta: é diagnóstico.",
    es: "90 minutos con entregable físico. Mapeo completo de perfil, riesgos, estrategias y cronograma. No es una consulta: es un diagnóstico.",
    en: "90 minutes with a physical deliverable. Full mapping of profile, risks, strategies and timeline. It is not a consultation: it is a diagnosis.",
  },
  ...
  "90 minutos estruturados": { "pt-BR": "90 minutos estruturados", es: "90 minutos estructurados", en: "90 structured minutes" },
  ...
  "90 minutos · Entregável físico": { "pt-BR": "90 minutos · Entregável físico", es: "90 minutos · Entregable físico", en: "90 minutes · Physical deliverable" },
  ...
  "Solicitar Assessment": { "pt-BR": "Solicitar Assessment", es: "Solicitar Assessment", en: "Request Assessment" },
  ...
  "Artigos escritos pela equipa da MOOVIA sobre os temas que mais impactam a jornada de transição internacional.": {
    "pt-BR": "Artigos escritos pela equipe da MOOVIA sobre os temas que mais impactam a jornada de transição internacional.",
  ...
  "O que é o Strategic Assessment de €250?": { "pt-BR": "O que é o Strategic Assessment de €250?", es: "¿Qué es el Strategic Assessment de 250 €?", en: "What is the €250 Strategic Assessment?" },
  ...
  "Não é um formulário de contato. É o início de um diagnóstico. Quanto mais você nos contar, mais preciso será o nosso retorno.": {
    "pt-BR": "Não é um formulário de contato. É o início de um diagnóstico. Quanto mais você nos contar, mais preciso será o nosso retorno.",
  ...
  "Cada contato é respondido pessoalmente pelo Frederico, sem chatbot, sem script.": {
    "pt-BR": "Cada contato é respondido pessoalmente pelo Frederico, sem chatbot, sem script.",
    es: "Cada contacto es respondido personalmente por Frederico, sin chatbot, sin guion.",
    en: "Every enquiry is answered personally by Frederico, with no chatbot and no script.",
  },
  "Resposta em até 2 horas em dias úteis": { "pt-BR": "Resposta em até 2 horas em dias úteis", es: "Respuesta en hasta 2 horas en días laborables", en: "Reply within 2 hours on business days" },
  ...
  "Aposentadoria em Portugal": { "pt-BR": "Aposentadoria em Portugal", es: "Jubilación en Portugal", en: "Retirement in Portugal" },
  ...
  "WhatsApp com código do país — ex: +55 11 99999-9999": { "pt-BR": "WhatsApp com código do país — ex: +55 11 99999-9999", es: "WhatsApp con código de país — ej.: +55 11 99999-9999", en: "WhatsApp with country code — e.g. +55 11 99999-9999" },
  ...
  "Marcar Conversa Gratuita diretamente": { "pt-BR": "Marcar Conversa Gratuita diretamente", es: "Agendar una conversación gratuita directamente", en: "Book a free consultation directly" },
